...
import { COUNTRY_CODE, MAX_NAME_LENGTH, MIN_NAME_LENGTH, TEL_LENGTH, URL_REGEX, formatProfileForm, formatTelNumber } from '../../utils/const';
...
@Component({
  ...
  templateUrl: './tel-input/tel-input.html',
  styleUrls: ['./tel-input/tel-input.css'],
